...
from os import listdir
from os.path import isfile, join
images_0 = [f for f in listdir('./correct_data/train/0') if isfile(join('./correct_data/train/0', f))]
images_1 = [f for f in listdir('./correct_data/train/1') if isfile(join('./correct_data/train/1', f))]
images_2 = [f for f in listdir('./correct_data/train/2') if isfile(join('./correct_data/train/2', f))]
